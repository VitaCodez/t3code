...
/** Same terminal ids (order ignored) Ă˘â‚¬â€ť avoids reconcile when only server session ordering differs. */
...
const PersistentThreadTerminalDrawer = memo(function PersistentThreadTerminalDrawer({
  ...
  // sessions Ă˘â‚¬â€ť an id collision attaches two viewports to one PTY session.
 ...
 * maintainScrollAtEnd switched off for as long as it is installed Ă˘â‚¬â€ť ChatView
...
export default function ChatView(props: ChatViewProps) {
  ...
  // Granular store selectors Ă˘â‚¬â€ť avoid subscribing to prompt changes.
  ...
  // stamped at the turn's completion time Ă˘â‚¬â€ť not now/updatedAt Ă˘â‚¬â€ť so it clears
          ...
          updateInProgress || updateFailed ? (
            ...
            <Tooltip>
              ...
              <TooltipPopup side="top">
                ...
                <span aria-hidden="true">Ă˘â€ â€™</span> {versionMismatch.clientVersion}
              </TooltipPopup>
            </Tooltip>
          ) : (
            "Server update available"
    ...
    const attach = (remainingAttempts: number) => {
      frame = requestAnimationFrame(() => {
        ...
        if (!scrollNode) {
          ...
          // switch Ă˘â‚¬â€ť without a retry the opt-out listeners never attach and
        ...
        // actually carried the viewport out of the end band Ă˘â‚¬â€ť an upward flick
  ...
  const handleStopBackgroundWork = useCallback(async () => {
    ...
    if (result._tag === "Failure") {
      // Every failure clears the pending state Ă˘â‚¬â€ť an interrupted command
      ...
      ...wokeThreadItems,
      {
        ...
        title: (
          <span className="flex min-w-0 items-baseline gap-1.5">
            <span className="shrink-0 font-normal text-muted-foreground">Branch changed Ă˘â‚¬â€ť was</span>
            <Tooltip>
              <TooltipTrigger
                render={
        ...
        <div className="flex min-h-0 min-w-0 flex-1">
          ...
          >
            ...
            <div className="relative flex min-h-0 flex-1 flex-col bg-background">
              {/* Messages Ă˘â‚¬â€ť LegendList handles virtualization and scrolling internally */}
              <MessagesTimeline
...
{...(!paintOnlyDisplayedTimeline
              ...
              {/* scroll to end pill Ă˘â‚¬â€ť shown when user has scrolled away from the live edge */}
              {showScrollToBottom && (
                <div
            ...
            {/* Input bar Ă˘â‚¬â€ť centered hero while a draft has no messages, docked at the bottom otherwise */}
            <div
